...
class UserQuestion(models.Model):
    ...
    def __str__(self):
        return f'{self.user_id=} {self.question=} {self.has_an_answer=} {self.likes_num=} {self.dislikes_num=}'
...
class UserAnswer(models.Model):
    ...
    def __str__(self):
        return f'{self.user_id=} {self.likes_num=} {self.dislikes_num=} {self.best_answer=}'